...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md bg-card rounded-2xl shadow-xl shadow-primary/5 border border-border/50 overflow-hidden">
      <div className="p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold tracking-tight mb-2">{t('loginTitle')}</h1>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <Button variant="outline" className="w-full h-11" type="button" onClick={() => signInWithProvider('google')}>
          ...
          <Button variant="outline" className="w-full h-11" type="button" onClick={() => signInWithProvider('github')}>
